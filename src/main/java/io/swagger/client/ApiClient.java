...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("X-Boomtown-Date", new ApiKeyAuth("header", "X-Boomtown-Date"));
    authentications.put("X-Boomtown-Signature", new ApiKeyAuth("header", "X-Boomtown-Signature"));
    authentications.put("X-Boomtown-Token", new ApiKeyAuth("header", "X-Boomtown-Token"));
